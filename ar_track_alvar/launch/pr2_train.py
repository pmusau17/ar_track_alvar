...
def generate_launch_description():
    return LaunchDescription([
        Node(
            ...
            node_executable='trainMarkerBundle', 
            output='screen',
            remappings=[
                ("camera_image", cam_image_topic),
                ("camera_info",cam_info_topic)
            ],
            arguments=[nof_markers, marker_size ,arg max_new_marker_error, max_track_error ,cam_image_topic, cam_info_topic, output_frame]
        ),
    ])